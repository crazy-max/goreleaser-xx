...
1. [Fork](https://github.com/crazy-max/goreleaser-xx/fork) and clone the repository
2. Configure and install the dependencies: `go mod download`
3. Create a new branch: `git checkout -b my-branch-name`
4. Make your changes
5. Validate: `docker buildx bake validate`
6. Test: `docker buildx bake test`
7. Build the project: `docker buildx bake image-all`
8. Push to your fork and [submit a pull request](https://github.com/crazy-max/goreleaser-xx/compare)
